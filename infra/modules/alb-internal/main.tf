# ==============================================================================
# INTERNAL ALB MODULE - Balanceador de la capa de aplicacion
# ==============================================================================
# Load balancer interno (HTTP) que distribuye trafico entre instancias backend.
# Recibe trafico unicamente desde la capa de frontend dentro de la VPC.
# ==============================================================================
...
resource "aws_lb_target_group" "backend" {
  name     = substr("${var.name_prefix}-be-tg-int", 0, 32)
  port     = 80
  protocol = "HTTP"
  vpc_id   = var.vpc_id
